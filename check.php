      ...
      ?>
        ...
        <li>Welcome:&nbsp;&nbsp;&nbsp;<a href="#profile" href  data-toggle="modal"><i class="icon-user icon-white"></i><?php echo $fetch['username']; ?></a></li>
					...
					<nav class="breadcrumbs">
						...
						<a href="koper.php">Koper</a> &rarr;
						<a href="details.php">Details</a> &rarr;
						<span>Form</span>
					</nav>
				</div>
			</header> <!-- .site-header -->
			...
			<main class="content">
				...
				<div class="fullwidth-block">
					<div class="container">
						<div class="row">
							<h2><center>Isi Data Penanggung Jawab</h2> </center><br>
							<div class="col-md-6 wow fadeInLeft">
								...
								<h3><table>
									<tr>
										...
										<td>
											&nbsp&nbsp <input type="text" name="name" maxlength="50" size="50"><br>
										</td>
									</tr>
									<br>
									<tr>
										...
										<td>
											&nbsp &nbsp<input type="text" name="email" maxlength="80" size="50"><br>
										</td>
									</tr>
									<br>
									<tr>
										...
										<td>
											&nbsp &nbsp<input type="text" name="telephone" maxlength="50" size="50"> <br> <br>
										</td>
									</tr>
									<br>
									<tr>
										...
										<td>
											&nbsp <textarea  name="address" maxlength="1000" cols="25" rows="6"></textarea> <br>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											&nbsp &nbsp<input type="text" name="person" maxlength="50" size="10">
										</td>
									</tr>
							...
							<right><div class="col-md-6 wow fadeInRight">
							<?php 
								if(isset($_GET['id']))
								{
									$id = $_GET['id'];
									$query = $conn->query("SELECT * FROM koper WHERE id = '$id' ");
									...
									echo "</br>";
									echo "</br>";
									echo "<strong>Rp ".$fetch['harga']." /orang </strong>";
									}
								}
							?>		
							</div></right>
