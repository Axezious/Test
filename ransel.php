					...
					<div class="container">
						...
						<div class="filterable-items">
							<div class="filterable-item sumatera">
								...
								<?php 
									$query1 = $conn->query("SELECT * FROM ransel Where regional = 'sumatera'") or die (mysqli_error());
									while($fetch = $query1->fetch_array())
										{
											$rows = $query1->fetch_array();
											echo "<div class='float'>";
											echo "<a href='details1.php?id=".$fetch['id']."'> 
							...
							<div class="filterable-item jawa">
								<article class="offer-item">
								<?php 
									$query1 = $conn->query("SELECT * FROM ransel Where regional = 'jawa'") or die (mysqli_error());
									while($fetch = $query1->fetch_array())
										{
											$rows = $query1->fetch_array();
											echo "<div class='float'>";
							...
							<div class="filterable-item kalimantan">
								<article class="offer-item">
								<?php 
									$query1 = $conn->query("SELECT * FROM ransel Where regional = 'kalimantan'") or die (mysqli_error());
									while($fetch = $query1->fetch_array())
										{
											$rows = $query1->fetch_array();
											echo "<div class='float'>";
							...
							<div class="filterable-item sulawesi">
								<article class="offer-item">
								<?php 
									$query1 = $conn->query("SELECT * FROM ransel Where regional = 'sulawesi'") or die (mysqli_error());
									while($fetch = $query1->fetch_array())
										{
											$rows = $query1->fetch_array();
											echo "<div class='float'>";
							...
							<div class="filterable-item balinusa">
								<article class="offer-item">
								<?php 
									$query1 = $conn->query("SELECT * FROM ransel Where regional = 'balinusa'") or die (mysqli_error());
									while($fetch = $query1->fetch_array())
										{
											$rows = $query1->fetch_array();
											echo "<div class='float'>";
							...
							<div class="filterable-item malpapu">
								<article class="offer-item">
								<?php 
									$query1 = $conn->query("SELECT * FROM ransel Where regional = 'malpapu'") or die (mysqli_error());
									while($fetch = $query1->fetch_array())
										{
											$rows = $query1->fetch_array();
											echo "<div class='float'>";
